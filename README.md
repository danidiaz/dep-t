...
[![dep-t.png](https://i.postimg.cc/CMbncLPW/dep-t.png)](https://postimg.cc/dDt01vKB)
...
- __Control.Monad.Dep.Has.Env__ has extra definitions that help when building environments of records.
